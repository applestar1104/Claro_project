<?php
    ...
    $variavel='especificacaoproducaoextrusao';
    
    // chama tabela
    $xcrud->table('uc2_especificacoesproducaoextrusao');
    // nome da tabela
    $xcrud->table_name('Especificações para Produção - Extrusão');
    ...
    $xcrud->label('humidadedamistura','Humidade da mistura');
    $xcrud->label('temperaturasdasmaquinas','Temperaturas das máquinas');
    $xcrud->label('velocidadedasmaquinas','Velocidade das máquinas');
    $xcrud->label('comprimentodosbastoescorpos','Comprimento dos bastões/corpos');
    $xcrud->label('densidade','Densidade');
    $xcrud->label('nome_'.$variavel.'','Nome');
    $xcrud->label('observacoes','Observações');
    $xcrud->no_editor('humidadedamistura');
    $xcrud->no_editor('temperaturasdasmaquinas');
    $xcrud->no_editor('velocidadedasmaquinas');
    $xcrud->no_editor('comprimentodosbastoescorpos');
    $xcrud->no_editor('densidade');
    // colunas a mostrar na listagem
    $xcrud->columns('cod_'.$variavel.',nome_'.$variavel.',humidadedamistura,temperaturasdasmaquinas,velocidadedasmaquinas,comprimentodosbastoescorpos,densidade,activo');
    // relações
	...
	$xcrud->set_var('nome_tabela','uc2_especificacoesproducaoextrusao');
