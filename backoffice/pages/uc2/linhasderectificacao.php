<?php
    ...
    $variavel='linhaderectificacao';
    
    // chama tabela
    $xcrud->table('uc2_linhasderectificacao');
    // nome da tabela
    $xcrud->table_name('Linhas de Rectificação');
	...
	$xcrud->set_var('nome_tabela','uc2_linhasderectificacao');
