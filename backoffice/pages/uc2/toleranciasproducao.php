<?php
    ...
    $variavel='toleranciaproducao';
    
    // chama tabela
    $xcrud->table('uc2_toleranciasproducao');
    // nome da tabela
    $xcrud->table_name('Tolerâncias de Produção');
    ...
    $xcrud->label('comprimento','Comprimento');
    $xcrud->label('diametro','Diâmetro');
    $xcrud->label('chanfre','Chanfre');
    $xcrud->label('humidade','Humidade');
    $xcrud->label('peroxidos','Peróxidos');
    $xcrud->label('forcadeextraccao','Força de Extracção');
    $xcrud->label('observacoes','Observações');
    $xcrud->no_editor('comprimento');
    $xcrud->no_editor('diametro');
    $xcrud->no_editor('chanfre');
    $xcrud->no_editor('humidade');
    $xcrud->no_editor('peroxidos');
    $xcrud->no_editor('forcadeextraccao');
    // colunas a mostrar na listagem
    $xcrud->columns('cod_'.$variavel.',nome_'.$variavel.',comprimento,diametro,chanfre,humidade,peroxidos,forcadeextraccao,activo');
    // relações
	...
	$xcrud->set_var('nome_tabela','uc2_toleranciasproducao');
