<?php
    ...
    $variavel='qualidade';
    // chama tabela
    $xcrud->table('uc2_qualidades');
    // nome da tabela
    $xcrud->table_name('Qualidades');
    // mostra todos os ids excepto o id=1
    $xcrud->where('id_qualidade !=',1);
    // nome das label
    $xcrud->label('cod_qualidade','Código');
    $xcrud->label('nome_qualidade','Nome');
	...
	$xcrud->set_var('nome_tabela','qualidades');
    $xcrud->set_var('nome_campo','id_qualidade');
