<?php
    ...
    $variavel='etiquetaop1';
    
    // chama tabela
    $xcrud->table('uc2_etiquetasop1');
    // nome da tabela
    $xcrud->table_name('Etiquetas Extrusão');
    // nome das label
	...
	$xcrud->relation('id_calibres','uc2_calibres','id_calibre','nome_calibre','activo = 1 ',false,true);
	
	$xcrud->set_var('nome_tabela','uc2_etiquetasop1');
