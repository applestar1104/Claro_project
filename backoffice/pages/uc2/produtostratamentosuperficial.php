<?php
    ...
    $variavel='produtotratamentosuperficial';
    
    // chama tabela
    $xcrud->table('uc2_produtostratamentosuperficial');
    // nome da tabela
    $xcrud->table_name('Produtos Tratamento Superficial');
	...
	$xcrud->set_var('nome_tabela','uc2_produtostratamentosuperficial');
