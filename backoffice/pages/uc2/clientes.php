...
$xcrud->table('uc2_clientes'); 
 ...
 $xcrud->relation('id_tipodemarcacao','uc2_tiposdemarcacao','id_tipodemarcacao','nome_tipodemarcacao','uc2_tiposdemarcacao.activo = 1 and uc2_tiposdemarcacao.id_tipodemarcacao!=1',false);
   ...
   // $xcrud->fields(array('login_activo','tipo','vip'), true);
    ...
    $xcrud->fields(array('criado_por','criado_em','actualizado_em','actualizado_por','password'), true, true, 'edit');
    $xcrud->fields(array('criado_por','criado_em','actualizado_em','actualizado_por'), true, true, 'create');
    $xcrud->fields(array('password','criado_em','actualizado_em','actualizado_por'), true, true, 'create');
   ...
   $xcrud->set_var('nome_tabela','uc2_clientes');
