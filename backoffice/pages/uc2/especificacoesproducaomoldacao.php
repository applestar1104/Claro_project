<?php
    ...
    $variavel='especificacaoproducaomoldacao';
    
    // chama tabela
    $xcrud->table('uc2_especificacoesproducaomoldacao');
    // nome da tabela
    $xcrud->table_name('Especificações para Produção - Moldação');
    ...
    $xcrud->label('mistura','Mistura');
    $xcrud->label('humidade','Humidade');
    $xcrud->label('referenciacola','Referência da cola');
    $xcrud->label('temperaturas','Temperaturas');
    $xcrud->label('velocidadeciclo','Velocidade de Ciclo');
    $xcrud->label('prensagem','Prensagem');
    $xcrud->label('densidadecorpos','Densidade dos corpos');
    $xcrud->label('observacoes','Observações');
    $xcrud->no_editor('mistura');
    $xcrud->no_editor('humidade');
    $xcrud->no_editor('velocidadedasmaquinas');
    $xcrud->no_editor('referenciacola');
    $xcrud->no_editor('temperaturas');
    $xcrud->no_editor('velocidadeciclo');
    $xcrud->no_editor('prensagem');
    $xcrud->no_editor('densidadecorpos');
    // colunas a mostrar na listagem
    $xcrud->columns('cod_'.$variavel.',nome_'.$variavel.',mistura,humidade,referenciacola,temperaturas,velocidadeciclo,prensagem,densidadecorpos,activo');
    // relações
	...
	$xcrud->set_var('nome_tabela','uc2_especificacoesproducaomoldacao');
