<?php
    ...
    // chama tabela
    $xcrud->table('docs_footers');
    // nome da tabela
    $xcrud->table_name('Footers');
    // mostra todos os ids excepto o id=1
    //$xcrud->where('id_lingua !=',1);
    // nome das label
    $xcrud->label('nome_footer','Nome');
    // colunas a mostrar na listagem
    $xcrud->columns('nome_footer,conteudo_footer,activo,principal');
	...
	$xcrud->set_var('nome_tabela','docs_footers');
    $xcrud->set_var('nome_campo','id_footer');
