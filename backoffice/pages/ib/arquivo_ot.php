<?php
    ...
    $xcrud->column_name('tca_entrada_empresa_max', 'TCA Máx C');
    $xcrud->label('tca_final_min', 'TCA Final Mín');
    $xcrud->label('tca_final_max', 'TCA Final Máx');
    ...
    $xcrud->columns('id_of,id_cliente,id_calibre,id_qualidade,quantidade,observacoes_gerais,tca_entrada_cliente_min,tca_entrada_cliente_max,tca_entrada_empresa_min,tca_entrada_empresa_max,tca_final_min,tca_final_max,data');     // relações
