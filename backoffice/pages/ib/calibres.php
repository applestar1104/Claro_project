<?php
	...
	$xcrud->field_tooltip('nome_calibre','Entra nome do calibre aqui');
	
	$xcrud->set_var('nome_tabela','ib_calibres');
    ...
    $xcrud->fields(array('criado_por','criado_em','actualizado_em','actualizado_por','principal'), true, true, 'create');
	  ...
	  //$xcrud->mass_alert('email_table','email','subscribe = 1','Email test','Hello {nome_calibre}!');
    ...
    //$xcrud->button('javascript: alert(\'{id_calibre}\');');
    echo $xcrud->render();
