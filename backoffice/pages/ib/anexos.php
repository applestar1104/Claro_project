<?php
   ...
   $xcrud->change_type('anexo', 'file', '', array('path'=>'../../uploads/anexos','thumbs' => 
	...
	$xcrud->relation('id_of','ib_ofs','id_of','id_of');
	$xcrud->relation('id_tipodeanexo','ib_tiposdeanexos','id_tipodeanexo','nome_tipodeanexo','id_tipodeanexo!=1 and activo=1'); //campo origem / tabela / destino / destino_nome
	$xcrud->set_attr('id_of',array('id'=>'id_of'));
	
	$xcrud->set_var('nome_tabela','ib_anexos');
