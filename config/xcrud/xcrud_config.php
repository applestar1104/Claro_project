...
$path = $_SERVER['DOCUMENT_ROOT'].'/claro/ini.php';
include($path);
...
class Xcrud_config
{
    ...
    public static $language = 'pt'; // sets default localization
    ...
    // editor
    public static $editor_url = 'config/xcrud/editors/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
