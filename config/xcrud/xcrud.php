...
class Xcrud
{
        ...
        'div', $tabs_head = 'ul', $tabs_row = 'li', $tabs_link = 'a', $tabs_content = 'div', $tabs_pane = 'div')
    {
        ...
        {
            $cont++;
            $linha = explode(".", $item['name']);
         
            $row_class = $this->theme_config('details_row')." linha_".$linha[1];
            ...
            if($mode=="view")
                 $out.='<div style="display:none;"><input type="hidden"  id="esconde_'.$linha[1].'" value="'.$item["field"].'"></div>';
