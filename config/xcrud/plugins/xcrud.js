				...
				if (Xcrud.config('editor_init_url')) {
					...
					if (typeof(tinyMCE) != 'undefined') {
						tinyMCE.init({
				            ...
				            toolbar1: "insertfile undo redo | pagebreak | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | fontselect fontsizeselect link image | forecolor backcolor",
				            toolbar2: '',
